...
Computing import hash for OOXML office file iceid\charge_07.20.doc.
...
File iceid\charge_07.20.doc has the vba imphash 87f2efdb7d55c3e43c83352b2b4e0def from the identifiers ['Win16', 'Win32', 'Win64', 'Mac', 'VBA6', 'VBA7', 'Project', 'Normal', 'autoopen', 'ActiveDocument', 'CustomXMLParts', 'Count', 'SelectNodes', 'ChildNodes', 'Shell', 'URLDownloadToFile', 'MSForms', 'UserForm', 'url', 'file'].

Computing import hash for OOXML office file iceid\decree.07.20.2020.doc.
...
Computing import hash for OOXML office file iceid\details 07.20.doc.
...
Computing import hash for OOXML office file iceid\docs 07.20.20.doc.
...
Computing import hash for OOXML office file iceid\documents-07.20.doc.
...
Computing import hash for OOXML office file iceid\enjoin.07.20.2020.doc.
...
Computing import hash for OOXML office file iceid\input.07.20.2020.doc.
	[PCODEDMP] All Identifiers = ['Word', 'VBA', 'Win16', 'Win32', 'Win64', 'Mac', 'VBA6', 'VBA7', 'Project1', 'stdole', 'Project', 'ThisDocument', '_Evaluate', 'Normal', 'Office', 'Document', 'Module1', 'nb', 'q2', 'QB', 'autoopen', 'zV', 'ActiveDocument', 'CustomXMLParts', 'Count', 'SelectNodes', 'ChildNodes', 'frm', 'download', 'Shell', 'wu', 'bn', 'nb1', 'e4', 'e', 'URLDownloadToFile', 'bB', 'Ta', 'j8', 'UF', 'gh', 'urlmon', 'UserForm1', 'MSForms', 'UserForm', 'url', 'file'].

Computing import hash for OOXML office file iceid\inquiry,07.20.doc.
...
Computing import hash for OOXML office file iceid\legal paper.07.20.doc.
...
Computing import hash for OOXML office file iceid\official paper-07.20.doc.
...
Computing import hash for OOXML office file iceid\prescribe -07.20.2020.doc.
...
Computing import hash for OOXML office file iceid\question,07.20.2020.doc.
